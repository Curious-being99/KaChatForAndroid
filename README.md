...
```bash
curl -fsSL https://raw.githubusercontent.com/KaspaSilver/KaChatForAndroid/main/scripts/kachat-cloud-setup.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/KaspaSilver/KaChatForAndroid/main/scripts/kachat-cloud-uninstall.sh | bash
```
